...
function App() {
  let spec = [
    ...
    },
    {
      ...
      price: 1400,
      photo:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQWiB7sVbYI0k5_L_FEveJIYFhME5hA-nDnIA&usqp=CAU",
    },
    {
      id: 5,
      brand: "Elle 18",
      ...
      sale: true,
      photo:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTkWgeP6jnnNfdczkTTsFDmY5ET22F5WLjwpQ&usqp=CAU",
    },
    {
      id: 6,
      brand: "Insight",
      ...
      sale: false,
      photo:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSTXzDY8PAplhdxAA1aen4R8QOI7apnk3MCsA&usqp=CAU",
    },
    {
      id: 7,
      brand: "Maybelline",
      ...
      sale: true,
      photo:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTVPrZIY8KOZQxmSuiZ_xN5JAJ9cbnDI32N6g&usqp=CAU",
    },
    {
      id: 8,
      brand: "Night Crimson",
      ...
      sale: false,
      photo:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTfj3MfhaNuIXPzOEYoCLhz8PevvmfFC0qiJMrntA8KOXp_oALfXFkNRfe3VKhStBD6YTg&usqp=CAU",
    },
  ];
          ...
          <section class=" py-5">
            <div class="container px-4 px-lg-5 mt-5">
              <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                {spec.map((data) => {
                  return (
                    <Products datas={data} buttonclick={addcart} cart={items} />
                  );
                })}
              </div>
            </div>
